...
import com.tefire.count.model.dto.NoteOperateMqDTO;
 ...
 * @Date: 2026-07-21 16:55:04
 * @Description: 计数: 笔记发布数
 */
@Component
@RocketMQMessageListener(consumerGroup = "bluenote_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
